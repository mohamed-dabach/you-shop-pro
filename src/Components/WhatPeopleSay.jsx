        ...
        <div className="container block lg:flex px-10 justify-between">
          <div className="">
            ...
            <div className="flex flex-col ">
              <h1 className="bold text-4xl self-start font-medium md:text-[48px] leading-tigh">
                what people say
              </h1>
              <a
                href="#"
                className="self-end bg-primary md:flex px-8 py-3 font-medium text-semi-black"
              >
