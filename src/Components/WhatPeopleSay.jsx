            ...
            <div className='container block lg:flex px-10 justify-between'>
                ...
                <div className='flex lg:mt-[0px] md:items-end  mt-[30px]'>
                        <span className=' max-w-[300px]'>
                            <a href="#">
                                <span className='bg-primary md:flex px-8 py-3 font-medium text-semi-black'>View All Testimonial</span>
                            </a>
                        </span>
                </div>
            </div>
            <div className='block lg:flex pt-[100px]'>
                ...
                <div className='min-w-[50%] mt-8 lg:mt-2'>
                    <div className='block md:flex p-8'>
                        <div className='min-w-[40%] m-0 md:ml-[-34px] md:mt-[-60px]'>
                            <span className='w-full h-full '>
                                <img style={{ boxShadow: "16px 24px 80px -16px rgba(0, 0, 0, 0.4)" }} loading='lazy' src="./man-wearing-glasses-avatar.jpg" alt="men" />
                            </span>
                        </div>
                        <div className='flex flex-col min-w-[60%] pl-0 md:pl-9 py-2'>
                            <span className='font-semibold mb-2'>
