...
export default function NewCollection({list}){
    ...
    return(<>
            ...
            <div className=" w-full lg:w-9/12 xl:w-9/12 md:w-12/12 h-96 ">
                  <div className="w-full lg:w-12/12 xl:w-12/12 mt-2 relative">
                    ...
                    <div className="w-full pt-7">
                        <button className="bg-primary w-7/12 px-4 py-3 text-semi-black tracking-widest text-[.8rem] font-semibold hover:bg-semi-gray hover:text-white hover:duration-700 hover:translate-y-0.5 ">SHOP THIS COLLECTION</button>
                    </div>
            </div>
         </div>
      ...
      <div className=" w-full h-auto flex flex-wrap justify-between my-24 ">
          ...
          <div className="w-full lg:w-3/12 xl:w-3/12 md:w-6/12 h-[82vh] relative">
              <img className="w-full h-full object-cover" src="./src/Assets/living-room-bg.jpg" alt="" />
              <div className="flex  w-auto absolute bottom-9 left-7 z-20">
                  <h1 className=" font-bold text-[1.6rem] text-white hover:text-secondary duration-500 "> <Link to={"rooms"}>Living Room</Link></h1>
                  <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#bc9127" className="w-6 h-6 mt-3 ml-2 hover:text-yellow-400 ">
          ...
          <div className="w-full lg:w-3/12 xl:w-3/12 md:w-6/12 h-[82vh] relative">
              <img className="w-full h-full object-cover" src="./src/Assets/bedroom-bg.jpg" alt="" />
              <div className="flex w-auto absolute bottom-9 left-7 z-20">
                  <h1 className=" font-bold text-[1.6rem] text-white hover:text-secondary duration-500 "> <Link to={"rooms"}>Bedroom</Link></h1>
                  <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#bc9127" className="w-6 h-6 mt-3 ml-2 hover:text-yellow-400 ">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                    </svg>
              </div>
              ...
              <div className="w-full lg:w-3/12 xl:w-3/12 md:w-6/12 h-[82vh] relative">
              <img className="w-full h-full object-cover" src="./src/Assets/kitchen-bg.jpg" alt="" />
              <div className="flex w-auto absolute bottom-9 left-7 z-20">
                  <h1 className=" font-bold text-[1.6rem] text-white hover:text-secondary duration-500 "> <Link to={"rooms"}>Kitchen</Link></h1>
                  <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#bc9127" className="w-6 h-6 mt-3 ml-2 hover:text-yellow-400 ">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                    </svg>
              </div>
              ...
              <div className="w-full lg:w-3/12 xl:w-3/12 md:w-6/12  h-[82vh] relative">
              <img className="w-full h-full object-cover" src="./src/Assets/bath-room-bg.jpg" alt="" />
              <div className="flex w-auto absolute bottom-9 left-7 z-20">
                  <h1 className=" font-bold text-[1.6rem] text-white hover:text-secondary duration-500 "> <Link to={"rooms"}>Bath Room</Link></h1>
                  <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#bc9127" className="w-6 h-6 mt-3 ml-2 hover:text-yellow-400 ">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                    </svg>
              </div>
