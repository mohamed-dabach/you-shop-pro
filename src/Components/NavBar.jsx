      ...
      >
        <div className="container  mx-auto flex max-w-[1440px] flex-col md:flex-row justify-start relative md:justify-between ">
          ...
          <div className="absolute right-20 md:relative md:right-0 ">
            <span className="  text-primary  relative hover:text-gray-300 md:flex items-center cursor-pointer">
              <div onClick={handleClick} className={`absolute  font-semibold top-[-5px] left-[-10px] flex justify-center items-center p-0 m-0 w-5 h-5 text-[12px] rounded-2xl 
