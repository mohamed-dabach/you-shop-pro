    ...
    <div className='block relative '>
      ...
      <div className='flex m-auto '>
        <div className='container mt-[100px] lg:mt-[150px]  px-10'>
          ...
          <div className='flex mb-5 justify-between mt-[100px] sm:mt-[150px] lg:mt-[200px]'>
            <div>
              <span>
                <a href="#">
            ...
            <div className='min-w-[200px]'>
              <div className='flex justify-between'>
                <span>
                  <a href="#">
                    <svg className='hover:fill-[#edb932]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-facebook" viewBox="0 0 16 16">
                ...
                <span>
                  <a href="#">
                    <svg className='hover:fill-[#edb932]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-twitter-x" viewBox="0 0 16 16">
                ...
                <span>
                  <a href="#">
                    <svg className='hover:fill-[#edb932]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-youtube" viewBox="0 0 16 16">
                ...
                <span>
                  <a href="#">
                    <svg className='hover:fill-[#edb932]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-instagram" viewBox="0 0 16 16">
