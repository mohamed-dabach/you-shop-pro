            ...
            <div className="w-full h-16 flex justify-between items-center px-6 border-b">
             ...
             <div className="w-full h-[78vh] flex flex-col justify-center items-center overflow-x-auto p-4" >
                {/* here we can add all product's commands */}
                 ...
                 <button className=" absolute left-6 bottom-4 right-6 bg-primary flex justify-center p-3 text-sm font-semibold tracking-widest hover:bg-semi-gray hover:text-white hover:translate-x-2 hover:duration-500 hover:rotate-1">CONTINUE SHOPPING</button>
        </div>
